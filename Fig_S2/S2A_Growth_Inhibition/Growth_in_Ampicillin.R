...
maxCa24 <- mean (G9[G9$Species == 'Ca' & G9$Time_hr > 23 & G9$Well == 'AB12', 5])
maxLp24 <- mean (G9[G9$Species == 'Lp' & G9$Time_hr > 23 & G9$Well == 'AB12', 5])
...
xlabels <- scale_x_discrete(limits = unique(rev(G9$Well)),labels=c("AB12" = "0.0", "AB11" = ".10","AB10" = "0.20", "A9" = ".39", "A8" = ".78", 
                                                                   "A7" = "1.6","A6" = "3.1","A5" = "6.3","A4" = "12.5","A3" = "25","A2" = "50","A1" = "100"))
...
pdf(paste(  "Growth_in_Ampicillin", ".pdf"), width=6, height=4)
print(plotii)
dev.off()
