...
maxCa24 <- mean (G9[G9$Species == 'Ca' & G9$Time_hr > 23 & G9$Well == 'HB12', 5])
maxLp24 <- mean (G9[G9$Species == 'Lp' & G9$Time_hr > 23 & G9$Well == 'HB12', 5])
...
xlabels <- scale_x_discrete(limits = unique(rev(G9$Well)),labels=c("HB12" = "0.0", "HB11" = ".10","HB10" = "0.20", "H9" = ".39", "H8" = ".78", 
                                                                   "H7" = "1.6","H6" = "3.1","H5" = "6.3","H4" = "12.5","H3" = "25","H2" = "50","H1" = "100"))
...
pdf(paste(  "Growth_in_Tetracycline", ".pdf"), width=6, height=4)
print(plotii)
dev.off()
