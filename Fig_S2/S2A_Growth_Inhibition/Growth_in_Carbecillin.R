...
maxCa24 <- mean (G9[G9$Species == 'Ca' & G9$Time_hr > 23 & G9$Well == 'BB12', 5])
maxLp24 <- mean (G9[G9$Species == 'Lp' & G9$Time_hr > 23 & G9$Well == 'BB12', 5])
...
xlabels <- scale_x_discrete(limits = unique(rev(G9$Well)),labels=c("BB12" = "0.0", "BB11" = ".10","BB10" = "0.20", "B9" = ".39", "B8" = ".78", 
                                                                   "B7" = "1.6","B6" = "3.1","B5" = "6.3","B4" = "12.5","B3" = "25","B2" = "50","B1" = "100"))
...
pdf(paste(  "Growth_in_Carbenicillin", ".pdf"), width=6, height=4)
print(plotii)
dev.off()
