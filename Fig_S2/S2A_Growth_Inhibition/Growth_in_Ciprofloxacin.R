...
maxCa24 <- mean (G9[G9$Species == 'Ca' & G9$Time_hr > 23 & G9$Well == 'CB12', 5])
maxLp24 <- mean (G9[G9$Species == 'Lp' & G9$Time_hr > 23 & G9$Well == 'CB12', 5])
...
xlabels <- scale_x_discrete(limits = unique(rev(G9$Well)),labels=c("CB12" = "0.0", "CB11" = ".10","CB10" = "0.20", "C9" = ".39", "C8" = ".78", 
                                                                   "C7" = "1.6","C6" = "3.1","C5" = "6.3","C4" = "12.5","C3" = "25","C2" = "50","C1" = "100"))
...
pdf(paste(  "Growth_in_Ciprofloxacin", ".pdf"), width=6, height=4)
print(plotii)
dev.off()
