...
maxCa24 <- mean (G9[G9$Species == 'Ca' & G9$Time_hr > 23 & G9$Well == 'FB12', 5])
maxLp24 <- mean (G9[G9$Species == 'Lp' & G9$Time_hr > 23 & G9$Well == 'FB12', 5])
...
pdf(paste(  "Growth_in_Gentamicin", ".pdf"), width=6, height=4)
print(plotii)
dev.off()
